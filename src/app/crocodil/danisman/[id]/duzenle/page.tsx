...
import { saveClient, getClient } from "@/lib/crocodil/storage";
    ...
    <div className="flex flex-col h-full" style={{ background: "#f8fffe" }}>
      ...
      <div className="px-5 py-4 border-b flex items-center justify-between" style={{ background: "white", borderColor: "#e5f7f5" }}>
        <div className="flex items-center gap-3">
          <Link href={`/crocodil/danisman/${id}`}>
          ...
          <div>
            <h1 className="text-lg font-bold text-gray-800">Danışanı Düzenle</h1>
            <p className="text-xs text-gray-400">Hasta kaydını güncelle</p>
          </div>
        </div>
        <motion.button
