...
export default function CoursesPage() {
  ...
  return (
    <div className="min-h-[80vh] gradient-sage flex items-center justify-center px-6 relative overflow-hidden">
      {/* Decorative blurs */}
      ...
      <motion.div
        ...
        className="bg-white rounded-3xl p-12 md:p-20 border border-sage-100 shadow-[0_8px_30px_rgba(90,143,106,0.08)] text-center space-y-6 max-w-lg relative z-10"
      >
